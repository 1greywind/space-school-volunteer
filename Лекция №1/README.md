...
2. Запустите КСП
3. В главном меню выбирите путнкт "Начать игру"
4. Далее выбирите "Соханенная игра"
...
6. На экране космического центра нажмите на значек Станции слежения слева (шестой сверху, с иконкой антены)
   либо нажмите на здание Станции слежения в космическом центре
7. Внутри станции слежения нажмите на значкек "H" внизу справа - откроется окно аддона Гиперэдит
8. В окне Гиперэдита выбирите Orbit Editr
