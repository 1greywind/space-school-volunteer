...
* перелета к Марсу с выходом на орбиту Марса.

### Как выполнять задания

1. Подготовьте рабочую среду
   1. Установите программу Kerbal Space Program (инструкцию по установке см. ниже) 
   2. Cкачайте архив с файлами занятий (ссылка будет добавлена после лекции)
...
7. Внутри станции слежения выберите один из космических аппаратов и перейдите к нему двойным щелчком
8. тобы создавать маневры, перейдите на режим карты, нажав клавишу М
